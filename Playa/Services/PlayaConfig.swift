...
enum PlayaConfig {
    ...
    static let privacyURL = URL(string: "https://github.com/tooyakov-art/playa-ios/blob/main/PRIVACY.md")!
    static let termsURL = URL(string: "https://github.com/tooyakov-art/playa-ios/blob/main/TERMS.md")!
    static let offerURL = URL(string: "https://github.com/tooyakov-art/playa-ios/blob/main/OFFER.md")!
    static let refundURL = URL(string: "https://github.com/tooyakov-art/playa-ios/blob/main/REFUND.md")!
    static let supportEmail = "support@playahub.app"
    static let appVersion = "1.0.0"
    static let appBuild = "14"
}
