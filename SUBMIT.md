...
4. **Screenshots** — 6.9" iPhone portrait screenshots first (`1320x2868`, `1290x2796`, or `1260x2736`). Add 5.5" only if App Store Connect asks for the legacy slot. Build 16 is iPhone-only.
